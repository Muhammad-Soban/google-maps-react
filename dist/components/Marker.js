(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', '../lib/String', '../lib/areObjectsEqual'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('../lib/String'), require('../lib/areObjectsEqual'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.String, global.areObjectsEqual);
    global.Marker = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _String, _areObjectsEqual) {
  'use strict';
  ...
  var Marker = exports.Marker = function (_React$Component) {
    ...
    _createClass(Marker, [{
      ...
      value: function componentDidUpdate(prevProps) {
        if (this.props.map !== prevProps.map || !(0, _areObjectsEqual.areObjectsEqual)(this.props.position, prevProps.position) || this.props.icon !== prevProps.icon) {
          if (this.marker) {
